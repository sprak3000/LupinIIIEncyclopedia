...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
  <head>
    ...
    <link rel="stylesheet" href="/dist/unify-1.8/css/headers/header-v1.css">
...
?>
    <div class="wrapper">
      <?php /** Header */ ?>
      <div class="header-v1<?php if(isset($homeNav)) { ?> margin-bottom-40<?php } ?>">
        <div class="container">
        </div>
            ...
            <div class="container">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                  <img id="logo-header" class="img-responsive" src="/dist/asset/img/lupin-encyclopedia-banner.png" alt="Home | Lupin III Encyclopedia">
                </a>
              </div>
