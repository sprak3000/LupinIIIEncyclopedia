<div class="container">
  ...
  <div class="row margin-bottom-30">
    ...
    <div class="col-md-8">
      ...
      <p>The most interesting tidbit about this game it the name of the programmer, Yamada Yasuo. No one is sure if this is the iconic voice actor; Yamada was known for being fond of PCs. Unfortunately, we will likely never know if Yamada left his mark on the franchise with more than just his voice.</p>
      <p>More information and screenshots can be seen on the Japanese language site <a target="_blank" class="linked color-green" href="http://typerlpn3.web.fc2.com/sub14_07.htm">Typer's Lupin the Third Search Team</a>.</p>
    </div>
