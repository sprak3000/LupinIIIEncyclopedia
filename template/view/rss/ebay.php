...
?>
    <item>
      ...
      <description><![CDATA[<div><div style="margin-right:20px;float:left;"><?php if(isset($item['galleryURL'][0])) { ?><img src="<?php echo $item['galleryURL'][0]; ?>"/><?php } ?></div><div><strong>Current Price:</strong> <?php echo $currentPrice . ' ' . $currency; ?> (<?php echo (isset($item['sellingStatus'][0]['bidCount'][0])) ? $item['sellingStatus'][0]['bidCount'][0] : '0'; ?> bids)</div><div><strong>End Date:</strong> <?php echo $endsOn; ?></div><div><a rel="nofollow" target="_blank" href="<?php echo $item['viewItemURL'][0]; ?>">Bid Now</a> | <a rel="nofollow" target="_blank" href="http://cgi1.ebay.com/ws/eBayISAPI.dll?MfcISAPICommand=MakeTrack&item=<?php echo $ebayItemId; ?>">Add to Watch List</a></div></div>]]></description>
