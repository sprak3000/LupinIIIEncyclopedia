...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/dist/asset/img/jquery-lightbox/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/dist/asset/img/jquery-lightbox/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/dist/asset/img/jquery-lightbox/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:		'/dist/asset/img/jquery-lightbox/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
